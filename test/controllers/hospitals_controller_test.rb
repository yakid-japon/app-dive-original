...
class HospitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post hospitals_url, params: { hospital: { hospi_adresse: @hospital.hospi_adresse, hospi_name: @hospital.hospi_name } }
    end
  ...
  test "should update hospital" do
    patch hospital_url(@hospital), params: { hospital: { hospi_adresse: @hospital.hospi_adresse, hospi_name: @hospital.hospi_name } }
